...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>My Ezra PlaceLink - Cloud Storage</title>
        <meta name="description" content="This is a test assignment for place link by ezra" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div>
        <FileHeader headerName={"My Ezra PlaceLink Cloud Storage"} />
