...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>Bin - Ezra PlaceLink - Cloud Storage</title>
        <meta name="description" content="This is a Ezra PlaceLink - Cloud Storage" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div>
        <FileHeader headerName={"Bin for Ezra PlaceLink - Cloud Storage"} />
